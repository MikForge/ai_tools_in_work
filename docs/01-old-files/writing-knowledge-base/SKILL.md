...
description: Use when the user wants to save, archive, or organize markdown documentation into the project knowledge base (docs/00-project-harness-knowledge-base/). Triggers include "write this to knowledge base", "archive this doc", "save to KB", "整理到知识库", "归档文档", "写入知识库".
